...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(109983668079237).Name .. " 〢 Astro Hub",
    SubTitle = "discord.gg/tSeT4BV5wq",
    TabWidth = 30,
...
Tabs.Updates:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/tSeT4BV5wq")
        Fluent:Notify({ Title = "Astro Hub", Content = "Copied Successfully", Duration = 2 })
    end
})
